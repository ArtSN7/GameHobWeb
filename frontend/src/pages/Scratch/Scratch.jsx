...
export default function ScratchTheCardPage() {
  ...
  const { user, profile, balance, setBalance, isLoading, isAuthenticated, updateBalance } = useUser();
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#333333]">
      <InGameHeader IsShowGuide={true} title={"Scratch Rules"} description={ScratchTheCardDescription} />
