...
import { Ambulance, Coins, Eye, EyeOff } from "lucide-react";
...
export default function SlotsPage() {
  const { user, profile, balance, setBalance, isAuthenticated, isLoading, updateBalance } = useUser();
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#333333]">
      <InGameHeader IsShowGuide={true} title={"Slots Rules"} description={SlotsDescription} />
